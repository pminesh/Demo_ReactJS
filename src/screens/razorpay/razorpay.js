...
import { REACT_APP_PUBLIC_KEY, REACT_APP_SECRET_KEY } from "../../constant/payment/payment";
...
const RazorpayPayment = () => {
  ...
  const showRazorpay = async () => {
    ...
    bodyData.append("currency", amount.toString());
    bodyData.append("bill_id", bill_id);
    ...
    <HOC name="razorpay">
      <div className="container" style={{ marginTop: "10vh" }}>
        <form>
          ...
          <div className="form-group">
            <label htmlFor="exampleInputPassword1">Currency</label>
            <input
              type="text"
              className="form-control"
              placeholder="Ex:INR"
